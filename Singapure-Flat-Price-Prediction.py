...
with tab1:
    ...
    with col2:
        ...
        st.write('* The ML model used in this project is :blue[Linear regression].')
        st.write('* Linear regression Regressor had a high :red[R-squared score], which means it has performed best. ')
